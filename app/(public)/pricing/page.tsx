...
import { CheckIcon, PricingCard } from '@features/pricing'
...
const plans = [
  ...
  },
  {
    ...
    cta: 'Me interesa',
    ctaLink: null, // Will open waitlist modal in Task 2
    highlighted: true,
    badge: 'Próximamente',
  },
]
              ...
              <table className="w-full">
                ...
                <tbody>
                  {comparisonFeatures.map((row, index) => (
                    <tr
                      key={row.feature}
                      className={index !== comparisonFeatures.length - 1 ? 'border-b border-neutral-light' : ''}
                    >
                ...
                <tfoot>
                  <tr className="border-t border-neutral-light">
                    ...
                    <td className="bg-primary/5 px-6 py-6 text-center">
                      <button
                        disabled
                        className="inline-block cursor-not-allowed rounded-lg bg-neutral-light px-6 py-2 font-medium text-neutral-medium"
                      >
                        Próximamente
                      </button>
                    </td>
